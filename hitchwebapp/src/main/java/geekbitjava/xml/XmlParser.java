...
public class XmlParser {
	...
	public void parseDTXML() {
		...
		try {
			...
			File fXmlFile = new File("xmlFiles/deliverytrans.xml");
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					dtList.get(index).setUserid(Integer.parseInt(eElement.getElementsByTagName("user_id").item(0).getTextContent()));
					dtList.get(index).setDriverid(Integer.parseInt(eElement.getElementsByTagName("driver_id").item(0).getTextContent()));
	...
	public void parseTTXML() {
		...
		try {
			...
			//NOTE: IN FINAL DEV --> REMOVE HARD CODING OF FILE LOCATION
			File fXmlFile = new File("xmlFiles/taxitrans.xml");
			DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			Document doc = dBuilder.parse(fXmlFile);
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					taxList.get(index).setUserid(Integer.parseInt(eElement.getElementsByTagName("user_id").item(0).getTextContent()));
					taxList.get(index).setDriverid(Integer.parseInt(eElement.getElementsByTagName("driver_id").item(0).getTextContent()));
	...
	public void parseUserXML() {
		...
		try {
			...
			//NOTE: IN FINAL DEV --> REMOVE HARD CODING OF FILE LOCATION
			File fXmlFile = new File("xmlFiles/users.xml");
			DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			Document doc = dBuilder.parse(fXmlFile);
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					//fill out the deliveryTransactions obj
					UsrList.get(index).setUserid(Integer.parseInt(eElement.getElementsByTagName("user_id").item(0).getTextContent()));;
	...
	public void parsePaymentXML() {
		...
		try {
			...
			//NOTE: IN FINAL DEV --> REMOVE HARD CODING OF FILE LOCATION
			File fXmlFile = new File("xmlFiles/payment.xml");
			DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			Document doc = dBuilder.parse(fXmlFile);
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					//fill out the payment obj
					PayList.get(index).setNameOnCard(eElement.getElementsByTagName("name_on_card").item(0).getTextContent());;
					PayList.get(index).setCardNumber(eElement.getElementsByTagName("card_number").item(0).getTextContent());;
					PayList.get(index).setExpDate(eElement.getElementsByTagName("exp_date").item(0).getTextContent());;
					PayList.get(index).setCCV(Short.parseShort(eElement.getElementsByTagName("ccv").item(0).getTextContent()));;
					PayList.get(index).setUserid(Integer.parseInt(eElement.getElementsByTagName("user_id").item(0).getTextContent()));;
	...
	public void parseVehiclesXML() {
		...
		try {
			...
			//NOTE: IN FINAL DEV --> REMOVE HARD CODING OF FILE LOCATION
			File fXmlFile = new File("xmlFiles/vehicles.xml");
			DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			Document doc = dBuilder.parse(fXmlFile);
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					VList.get(index).setuid(Integer.parseInt(eElement.getElementsByTagName("uid").item(0).getTextContent()));;
	...
	public void parseDriversXML() {
		...
		try {
			...
			//NOTE: IN FINAL DEV --> REMOVE HARD CODING OF FILE LOCATION
			File fXmlFile = new File("xmlFiles/drivers.xml");
			DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			Document doc = dBuilder.parse(fXmlFile);
			...
			for (int index = 0; index < nList.getLength(); index++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					DriverList.get(index).setUserId(Integer.parseInt(eElement.getElementsByTagName("user_id").item(0).getTextContent()));;
